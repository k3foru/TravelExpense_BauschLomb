...
public class PreApprovalClaim_TestCases extends TestNgHelper{
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab and Verify Elements are present on page.");
		...
		log("Verified: Request no. are a link");
		...
		log("Verified: Verify list of records should be displayed in a tabular format under columns on the page:");
		...
		log("Verified: application navigates to view pre approval page");
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab to Add new Claim, verify Elements and fields validation while Applying on page.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
		...
		log("Verified: 'Pre-Approval Form' level present.");
		...
		log("Verified The Elements : 'Request No', 'Filed By', fields are NonEditable Text Field");
		preApprovalClaim.checkFieldValidation_PreApprovalForm();
		log("Verified: All Elements and there validation");
		...
		log("Verified: Total added Expense amount are displaying on Listing page for Added request.");
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab to Add new Claim, Save the the Expense and Verify Request Status, View, and Delete Action on the listing page.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
		// On Pre Approval Request Listing page - click to 'Add New Button' to add new claim.
		...
		log("Verified: the Requester name, Status, fileClaim, Actions for Added Request data present.");
		// Click to view Img Button of Drafted Request, and Verify All Added Details and fields nonEditable.
		...
		log("Verified: All Entered data record are Appearing in corresponding fields, And 'Submit', 'Save' Button not displaying on View page");
		...
		log("Verified: click cancle to Delete record, record not deleted.");
		preApprovalClaim.clickDeleteForDraftedRequest();
		Thread.sleep(1000);
		...
		log("Verified: click 'Ok' to Delete record, record Deleted.");
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab to Add new Claim, Save the the Expense and Verify Edit Action on the listing page.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
		// On Pre Approval Request Listing page - click to 'Add New Button' to add new claim.
		...
		Assert.assertTrue(isTextPresent(sRPF.preApprovalClaim_Data.get("PreApprovalForm_txtBusinessPurposeNPlan")));
		Assert.assertEquals(webDriver.findElement(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalForm_lblSubTotal"))).getText(), PreApprovalClaim.totalSub);
		log("Verified: Added Expense amount is : "+PreApprovalClaim.totalSub);
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalForm_BackButton"))));
		...
		log("Verified: All Entered data record are Appearing in corresponding fields, And 'Submit', 'Save' and 'Delete' Button displaying on Edit page");
		...
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_ExpenseBudget"))).getText(), PreApprovalClaim.totalSub+".00");
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Status"))).getText(), "Draft");
		log("Verified: Added Expense record Edited with same Request No and updated amount : "+PreApprovalClaim.totalSub);
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab to Add new Claim, Submit the the Expense and Verify Status, View Action on the listing page.");
		sRPF = new Set_Read_ProperpertiesFile();
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
		// On Pre Approval Request Listing page - click to 'Add New Button' to add new claim.
		...
		preApprovalClaim.clickToSubmitButtonToVerifyAlert();
		Thread.sleep(1000);
		Alert alert = webDriver.switchTo().alert();
		log("\n\n Click to Submit and, check the Validation Msg :: "+alert.getText());
		alert.dismiss();
		Thread.sleep(1000);
		log("\n\n Click to Submit and, cancle the Alert, request not submited");
		preApprovalClaim.clickToSubmitButtonToVerifyAlert();
		Thread.sleep(1000);
		Alert alert1 = webDriver.switchTo().alert();
		...
		log("Verified: the Requester name, Status, fileClaim, Actions for Added Request data and element present.");
		log("Verified: After Submit the request Status is : 'Awaiting approval from "+UserLogin.managerNameOfLoggedInUser+"'");
		...
		Assert.assertFalse(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalForm_SaveButton"))));
		Assert.assertFalse(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalForm_SubmitButton"))));
		log("Verified: View page of Submited Request : All Entered data record are Appearing in corresponding fields, And 'Submit', 'Save' Button not displaying on View page");
		...
		log("Verified: View Commetns Window having no Comments till now");
		//webDriver.close();
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab to Add new Claim, Submit the the Expense and Verify Cancel Action and Status on the listing page.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
		// On Pre Approval Request Listing page - click to 'Add New Button' to add new claim.
		...
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_imgEdit"))));
		log("\n\n Click to Cancel and, accept the Alert, request Cancelled");
		...
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalForm_ViewCommentsButton"))));
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalForm_SubmitButton"))));
		log("Verified: All Entered data record are Appearing in corresponding fields, And 'Submit', 'ViewComments' and 'Back' Button displaying on Edit page");
		// Edit the Added record
		preApprovalClaim.updatePreApprovalAddedExpenseForm();
		preApprovalClaim.clickToSubmitButton();
		...
		if(!beforeCancelRequestID.equals(PreApprovalClaim.addedRequestNo))
			log("Verified: Edited Cancel Request and submit than New RequestNo. are Generating ");
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RequestNo"))).getText(), PreApprovalClaim.addedRequestNo);
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_ExpenseBudget"))).getText(), PreApprovalClaim.totalSub+".00");
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Status"))).getText(), "Awaiting approval from "+UserLogin.managerNameOfLoggedInUser);
		log("Verified: Cancel Expense record Edited and save with New Request No : "+PreApprovalClaim.addedRequestNo);
		log("Verified: Cancel Expense record Edited with Amount : "+PreApprovalClaim.totalSub);
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab, Check and verify paging on the PreApproval listing page.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
		// On Pre Approval Request Listing page - Check and verify paging.
		preApprovalClaim.checkAndVerifyForPaging();
		log("Paging Verification Done on 'Listing of Pre-Approvals' page.");
	}
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab, Search functionality on the PreApproval listing page.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.claimForPreApprovalRequest();
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab, Add one Claim and Verify the Reject and Approve claim from his Manager.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		...
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.myApprovals_Xpath.get("MyApprovalsList_DataGrid_ClaimNo"))).getText(), PreApprovalClaim.addedRequestNo);
		...
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.myApprovals_Xpath.get("MyApprovalsList_DataGrid_ClaimType"))).getText(), "Pre-Approval");
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.myApprovals_Xpath.get("MyApprovalsList_DataGrid_TotalExpense"))).getText(), PreApprovalClaim.totalSub+".00");
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.myApprovals_Xpath.get("MyApprovalsList_DataGrid_LastModified"))).getText(), PreApprovalClaim.addedDateTime);
		...
		log("Verified: On My Approvale View page 'Approve' and 'Reject' Button displaying.");
		// Reject the Claim.
		...
		log("Verified: claim Status is 'Approved' after Approved by Manager.");
		// Verified: for claim Status 'Approved' only 'View' and 'cancel' Img button displaying.
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_imgView"))));
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_imgCancel"))));
		log("Verified: for claim Status 'Approved' only 'View' and 'cancel' Img button displaying.");
		Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RejectedStatus"))).getText(), "Rejected");
		log("Verified: claim Status is 'Rejected' after Rejecte by Manager.");
		// Verified: for claim Status 'Rejected' only 'View' Img button displaying.
		Assert.assertTrue(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_RejectedimgView"))));
		...
		Assert.assertFalse(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_RejectedimgEdit"))));
		Assert.assertFalse(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_RejectedimgDelete"))));
		Assert.assertFalse(isElementPresent(By.id(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_Action_RejectedimgCancel"))));
	...
	{
		header("Login as a Normal User and Click to 'Pre-Approval Request' in Claim Tab, verify if 'Request Amount' Greater Than 'Approver Range Amount' than Claim should not submit (Alert Displaying) while submitting claim.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		UserLogin userLogin = new UserLogin();
		userLogin.userLogout();
		...
		preApprovalClaim.clickToAddNewClaimBtn();
		// On Pre-Approval Form page - Fill All Expense Information for 'Pre-Approval Request'.
		preApprovalClaim.fillPreApprovalExpenseFormExceedAmount();
		...
		if(requestAmount > approvalAmount){
			...
			log("Verified: Alert not Diplaying because Request Amount is not greater than Manager Approval Amount.");
	}
	...
	{
		header("Login as a Normal User who is neither admin user nor 'finance user' and verify in 'My Approvals Tab' 'No records found.' message display.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		preApprovalClaim.goToMyApprovalTab();
		Assert.assertTrue(isTextPresent("No records found."));
		Assert.assertTrue(isElementPresent(By.id("ctl00_cphMain_ddlSearchCriteria")));
		log("Verified: Log in as Normal User  - go to My Approval tab - 'No records found.' message displaying.");
	}
	
	// Login as a Normal User go to 'Pre Approval' Listing page and verify to Sorting of Requests list by 'Request no.' and 'Creation date'.
	@Test (description="Login as a Normal User go to 'Pre Approval' Listing page and verify to Sorting of Requests list by 'Request no.' and 'Creation date'.' message display.",groups = { "verifySortingListByRequestNoAndCreationDate" })
	public void verifySortingListByRequestNoAndCreationDate() throws Exception
	{
		header("Login as a Normal User go to 'Pre Approval' Listing page and verify to Sorting of Requests list by 'Request no.' and 'Creation date'.");
		sRPF = new Set_Read_ProperpertiesFile(); 
		PreApprovalClaim preApprovalClaim = new PreApprovalClaim();
		// go to Pre Approval Claim page and verify all the records displayed are sorted in descending order default with respect to the records in the respective column.
		preApprovalClaim.claimForPreApprovalRequest();
		String lastRequestNo = webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RequestNo"))).getText();
		String lastRequest = CommonUse.getSubStringFoRequestNo(lastRequestNo);
		String secondLastRequestNo = webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataSecondGrid_RequestNo"))).getText();
		String secondLastRequest = CommonUse.getSubStringFoRequestNo(secondLastRequestNo);
		...
		if(Integer.parseInt(lastRequest) > Integer.parseInt(secondLastRequest))
		...
		String lastRequestAddedDate = webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_CreationDate"))).getText();
		// click to Request id column list link to check the sorting of list.
		webDriver.findElement(By.xpath("//*[@id='ctl00_cphMain_grdPreApprovalList']/tbody/tr[1]/th[1]/a")).click();
		Thread.sleep(1000);
		try{
			Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RequestNo"))).getText(), lastRequestNo);
			//if(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RequestNo"))).getText().equals(lastRequestNo))
			log("Verified (checked with request no.): by click of 'Request id column list link' request lists are Not sortign in accending order.");
		}
		catch(Throwable e){
			log("Verified (checked with request no.) : by click of 'Request id column list link' request lists are sortign in accending order.");
		}
		try{
			Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_CreationDate"))).getText(), lastRequestAddedDate);
			log("Verified (checked with creation date) : by click of 'Request id column list link' request lists are Not sortign in accending order.");
		}
		catch(Throwable t){
			log("Verified (checked with creation date) : by click of 'Request id column list link' request lists are sortign in accending order.");
		}
		preApprovalClaim.claimForPreApprovalRequest();
		String lastRequestNoD = webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RequestNo"))).getText();
		String lastRequestAddedDateD = webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_CreationDate"))).getText();
		// click to creation date column list link to check the sorting of list.
		webDriver.findElement(By.xpath("//*[@id='ctl00_cphMain_grdPreApprovalList']/tbody/tr[1]/th[4]/a")).click();
		Thread.sleep(1000);
		try{
			Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_RequestNo"))).getText(), lastRequestNoD);
			log("Verified (checked with request no.): by click of 'creation date column list link' request lists are Not sortign in accending order.");
		}
		catch(Throwable e){
			log("Verified (checked with request no.) : by click of 'creation date column list link' request lists are sortign in accending order.");
		}
		try{
			Assert.assertEquals(webDriver.findElement(By.xpath(sRPF.preApprovalClaim_Xpath.get("PreApprovalsList_DataGrid_CreationDate"))).getText(), lastRequestAddedDateD);
